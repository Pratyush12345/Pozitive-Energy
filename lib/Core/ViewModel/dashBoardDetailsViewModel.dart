...
class DashBoardDetailsViewModel extends BaseModel {
  ...
  DashBoardDetailDataModel dashBoardDetailDataModel=DashBoardDetailDataModel();



  Future getDashBoardDetails(DashBoardDetailsCredential dashBoardDetailsCredential) async {
    ...
    final response = await _api.getDashBoardDetailsList(dashBoardDetailsCredential);
