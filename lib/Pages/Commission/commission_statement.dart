...
List<CustomPopupMenu> choices = <CustomPopupMenu>[
  CustomPopupMenu(title: 'Download All', assetImage: "assets/icon/download.png"),
  CustomPopupMenu(title: 'Download Invoice', assetImage:"assets/icon/download-invoice.png"),
  CustomPopupMenu(title: 'Commission Detail', assetImage: "assets/icon/commission-detail.png"),
  CustomPopupMenu(title: 'Commission Status', assetImage:"assets/icon/commission-status.png"),
  CustomPopupMenu(title: 'Alliance Commission', assetImage: "assets/icon/Alliance Commission.png"),
];
            ...
            children: <Widget>[
              InkWell(
                child: Container(
                  ...
                  child: Center(
                    child: Text("Partner",style: TextStyle(color: partner?Color.fromRGBO(20, 121, 70, 1):Color.fromRGBO(123, 123, 123, 1),fontSize: MediaQuery.of(context).size.height*.022),),
                  ),
                  decoration: BoxDecoration(
                      color: Colors.white,
                      border: Border(bottom: partner?BorderSide(color: Color.fromRGBO(20, 121, 70, 1),width: 2):BorderSide(color: Colors.transparent))
                  ),
                ),
                onTap: (){
                  setState(() {
              ...
              InkWell(
                child: Container(
                  ...
                  height: MediaQuery.of(context).size.height*.08,
                  child: Center(
                    child: Text("Renewal",style: TextStyle(color: partner?Color.fromRGBO(123, 123, 123, 1):Color.fromRGBO(20, 121, 70, 1),fontSize: MediaQuery.of(context).size.height*.022)),
                  ),
                  decoration: BoxDecoration(
                      color: Colors.white,
                      border: Border(bottom: partner?BorderSide(color: Colors.transparent):BorderSide(color: Color.fromRGBO(20, 129, 88, 1),width: 2))
                  ),
                ),
                onTap: (){
                  setState(() {
                      ...
                      child: Row(
                        children: <Widget>[
                          ...
                          Container(
                              ...
                              child: Text("Invoice Total",style: TextStyle(color: Colors.white,fontWeight: FontWeight.bold,fontSize: MediaQuery.of(context).size.height*0.02),)
                          )
                        ],
                      ),
                    ),
                                        ...
                                        child: Row(
                                          children: <Widget>[
                                            SizedBox(
                                                ...
                                                child: Text("${requestedlist[0]["invoice_total"]}",style: TextStyle(color: Colors.black,fontSize: MediaQuery.of(context).size.width*0.029),)),
                                            Spacer(),
                                            Transform.scale(
                                              scale: 1,
                                              child: SizedBox(
