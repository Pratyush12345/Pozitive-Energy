          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: innertextfield(companyName, false, _autovalidation,
                  TextInputType.text, "Register Company Name", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfield(companyRegNo, false, _autovalidation,
                  TextInputType.number, "Company Reg. No.", (value) {
                if (value.isEmpty) {
                  return 'Please enter Register Company Name';
                }
                return null;
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(charityRegNo, false, _autovalidation,
                  TextInputType.number, "Charity Reg. No.", (value) {
                if (value.isEmpty) {
