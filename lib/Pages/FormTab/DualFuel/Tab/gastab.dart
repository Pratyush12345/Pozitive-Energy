...
//            ),
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(unitCharge, false, _autovalidation,
                  TextInputType.number, "Unit Charge", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfield(
                  aq, false, _autovalidation, TextInputType.number, "AQ Charge",
                  (value) {
                if (value.isEmpty) {
            ...
            InkWell(
              ...
              onTap: () {
                ...
                dualFuelAddProspectModel.accountId =
                    Provider.of<User>(context, listen: false).accountId;
                dualFuelAddProspectModel.fullMprn = mprnController.text;
                dualFuelAddProspectModel.strStandingChargeGas =
                    standingCharge.text;
                dualFuelAddProspectModel.strUnitPriceGas = unitCharge.text;
                //remaining additions
                /*
                contractstartdate
                aq
