          ...
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: innertextfield(
                  name, false, _autovalidation, TextInputType.text, "Name",
                  (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfieldEmail(email, false, _autovalidation,
                  TextInputType.emailAddress, "Email Address", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .062,
              child: innertextfield(phone, false, _autovalidation,
                  TextInputType.number, "Phone No", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfield(mobile, false, _autovalidation,
                  TextInputType.number, "Mobile No", (value) {
                if (value.isEmpty) {
            ...
            InkWell(
              ...
              onTap: () {
                ...
                electricityAddProspectModel.strEAName = name.text;
                electricityAddProspectModel.strEAEmail = email.text;
                electricityAddProspectModel.strEAMobileNo = mobile.text;
                electricityAddProspectModel.strEAPhoneNo = phone.text;
