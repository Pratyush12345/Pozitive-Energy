          ...
          children: <Widget>[
            ...
            InkWell(
              ...
              onTap: () {
                ...
                gasAddProspectModel.businessName = businessnamecontroller.text;
                gasAddProspectModel.businessType = businessTypeController.text;
                gasAddProspectModel.telNo = landline.text;
                gasAddProspectModel.email = email.text;
                gasAddProspectModel.strNameOfBill = nameOnBill.text;
                gasAddProspectModel.strSupplyName = supplyName.text;
                gasAddProspectModel.strCompanyRegNo = companyName.text;
                gasAddProspectModel.alternativeNumber = mobile.text;
                gasAddProspectModel.registeredCompanyName = companyName.text;
                gasAddProspectModel.btePaperBill = payperbill.toString();
                gasAddProspectModel.btemicrobuisnes = microbusiness.toString();
                gasAddProspectModel.strPropertOwnerShip =
                    propetyOwnership.toString();
                gasAddProspectModel.strCustomerRefNo = customerRefId.text;
