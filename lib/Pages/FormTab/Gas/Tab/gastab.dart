...
//            ),
            ...
            InkWell(
              ...
              onTap: () {
                ...
                gasAddProspectModel.accountId =
                    Provider.of<User>(context, listen: false).accountId;
                gasAddProspectModel.fullMprn = mprnController.text;
                gasAddProspectModel.strStandingChargeGas = standingCharge.text;
                gasAddProspectModel.strUnitPriceGas = unitCharge.text;
                //remaining additions
                /*
                contractstartdate
                aq
