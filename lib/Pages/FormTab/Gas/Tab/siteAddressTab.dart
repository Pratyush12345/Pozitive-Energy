...
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, address1Controller, _autovalidation,
                  TextInputType.text, "Site Address 1", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfield(cityController, false, _autovalidation,
                  TextInputType.text, "Site City", (value) {
                if (value.isEmpty) {
...
//              height: MediaQuery.of(context).size.height*.062,
              child: innerLongtextfield(5, address2Controller, _autovalidation,
                  TextInputType.text, "Site Address 2", (value) {
                if (value.isEmpty) {
            ...
            SizedBox(
              ...
              child: innertextfield(postcode, false, _autovalidation,
                  TextInputType.number, "Site Post Code", (value) {
                if (value.isEmpty) {
            ...
            InkWell(
              ...
              onTap: () {
                ...
                gasAddProspectModel.strSiteAddress1 = address1Controller.text;
                gasAddProspectModel.strSiteAddress2 = address2Controller.text;
                gasAddProspectModel.strSitePostCode = postcode.text;
                gasAddProspectModel.strSiteTown = cityController.text;
