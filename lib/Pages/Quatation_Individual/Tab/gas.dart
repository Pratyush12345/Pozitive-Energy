        ...
        child: ListView(
          children: <Widget>[
            ...
            SizedBox(
              ...
              child: innertextfield(mprnController,false,_autovalidation,TextInputType.number,"Gas MPRN",
                      (value) {
                    if (value.isEmpty) {
            ...
            Text("AQ",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            SizedBox(
              height: MediaQuery.of(context).size.height*.062,
              child: innertextfield(aqController,false,_autovalidation,TextInputType.number,"AQ",
                      (value) {
                    if (value.isEmpty) {
            ...
            Container(
              ...
              child: Center(
                child: Text("UPDATE QUOTE",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.height*0.017,
