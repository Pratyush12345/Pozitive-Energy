      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(dayBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(nightBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(eweBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      Text("SC",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,),),
                      SizedBox(
                        height: MediaQuery.of(context).size.height*0.01,
                      ),
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(scBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(dayRequiredBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(nightRequiredBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(eweRequiredBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(scRequiredBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(dayFinalBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(nightFinalBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(eweFinalBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(scFinalBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
            ...
            Text("Affiliate Uplist",style: TextStyle(color:themeApp.greenappcolor,fontSize: MediaQuery.of(context).size.height*.02,fontWeight: FontWeight.bold)),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.004,
            ),
            Container(
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(dayAffiliateBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(nightAffiliateBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(eweAffiliateBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
                  ...
                  child: Column(
                    ...
                    children: <Widget>[
                      ...
                      SizedBox(
                        ...
                        width: MediaQuery.of(context).size.width*.46,
                        height: MediaQuery.of(context).size.height*.062,
                        child: innertextfield(scAffiliateBaseRate,false,_autovalidation,TextInputType.number,"",
                                (value) {
                              if (value.isEmpty) {
                                return 'Please enter Postcode';
                              }
            ...
            Text("Supply Capacity(kVA):",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            SizedBox(
              ...
              height: MediaQuery.of(context).size.height*.062,
              child: innertextfield(supplyCapacity,false,_autovalidation,TextInputType.number,"",
                      (value) {
                    if (value.isEmpty) {
                      return 'Please enter Postcode';
                    }
            ...
            Text("EMR CFD(p/Unit):",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            SizedBox(
              ...
              height: MediaQuery.of(context).size.height*.062,
              child: innertextfield(emrCFD,false,_autovalidation,TextInputType.number,"",
                      (value) {
                    if (value.isEmpty) {
                      return 'Please enter Postcode';
                    }
            ...
            Text("Excess capacity charges pence per kVA:",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            SizedBox(
              ...
              height: MediaQuery.of(context).size.height*.062,
              child: innertextfield(excessCapacityCharges,false,_autovalidation,TextInputType.number,"",
                      (value) {
                    if (value.isEmpty) {
                      return 'Please enter Postcode';
                    }
            ...
            Text("Reactive Charge pence per kVArh:",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            SizedBox(
              ...
              height: MediaQuery.of(context).size.height*.062,
              child: innertextfield(reactiveCharge,false,_autovalidation,TextInputType.number,"",
                      (value) {
                    if (value.isEmpty) {
                      return 'Please enter Postcode';
                    }
