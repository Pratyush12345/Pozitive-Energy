      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            Text("Common Uplift(Electricity)",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
            ...
            Row(
              ...
              children: <Widget>[
                SizedBox(
                  ...
                  child: innertextfield(commonElectricityUplift,false,_autovalidation,TextInputType.text,"Uplift",
                          (value) {
                        if (value.isEmpty) {
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonElectricitySCUplift,false,_autovalidation,TextInputType.text,"SC Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
            ...
            Text("Common Uplift(Gas)",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            Row(
              ...
              children: <Widget>[
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonGasUplift,false,_autovalidation,TextInputType.text,"Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonGasSCUplift,false,_autovalidation,TextInputType.text,"SC Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
            ...
            Text("Common Uplift(Electricity)(Affiliate)",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            Row(
              ...
              children: <Widget>[
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonElectricityAfUplift,false,_autovalidation,TextInputType.text,"Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonElectricityAfSCUplift,false,_autovalidation,TextInputType.text,"SC Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
            ...
            Text("Common Uplift(Gas)(Affiliate)",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            Row(
              ...
              children: <Widget>[
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonGasAfUplift,false,_autovalidation,TextInputType.text,"Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
                ...
                SizedBox(
                  height: MediaQuery.of(context).size.height*.062,
                  width: MediaQuery.of(context).size.width*.46,
                  child: innertextfield(commonGasAfSCUplift,false,_autovalidation,TextInputType.text,"SC Uplift",
                          (value) {
                        if (value.isEmpty) {
                          return 'Please enter Uplift';
                        }
            ...
            Text("Affiliate",style: TextStyle(fontSize: MediaQuery.of(context).size.height*.015,color: Color.fromRGBO(31, 33, 29, 1)),),
            SizedBox(
              height: MediaQuery.of(context).size.height*0.01,
            ),
            InkWell(
