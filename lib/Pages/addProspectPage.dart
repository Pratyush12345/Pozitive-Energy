...
class _AddProspectPageState extends State<AddProspectPage>  with SingleTickerProviderStateMixin{
  ...
  final List<Tab> tabs = <Tab>[
    new Tab(icon: Row(
      children: <Widget>[
        Image.asset('assets/icon/gas.png',scale: 10,),
        SizedBox(
          width:8,
        ),
        Text("Gas")
    ...
    new Tab(icon: Row(
      children: <Widget>[
        Image.asset('assets/icon/Electricity.png',scale: 10,),
        SizedBox(
          width:8,
        ),
        Text("Electricity")
    ...
    new Tab(icon: Row(
      children: <Widget>[
        Image.asset('assets/icon/dual-fuel.png',scale: 10,),
        SizedBox(
          width:8,
        ),
        Text("Dual Fuel")
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        key: _scaffoldKey,
        appBar:AppBar(
          leading: InkWell(child: Image.asset("assets/menu.png",scale: 6,),
            onTap: (){
              _scaffoldKey.currentState.openDrawer();

            },),
          title: Text("Add Prospect",style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.width*0.048)),
          centerTitle: true,
          actions: <Widget>[
