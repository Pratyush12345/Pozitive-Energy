...
//                                    ),
                            ...
                            ListView.builder(
                                ...
                                shrinkWrap: true,
                                itemCount: model.dashBoardDetailDataModel
                                    .lstgetdetail.length,
                                itemBuilder: (BuildContext context, int index) {
                                  return Column(
                                    children: <Widget>[
...
//                                          ),
                                                    Text(
                                                      widget.type ==
                                                              AppString.group
                                                          ? "G${model.dashBoardDetailDataModel.lstgetdetail[index].intGroupId}"
                                                          : "I${model.dashBoardDetailDataModel.lstgetdetail[index].intId}",
                                                      style: TextStyle(
                                                          color: Colors.black,
                                              ...
                                              Container(
                                                  width: MediaQuery.of(context)
                                                      ...
                                                      .17,
                                                  child: Text(
                                                    "${model.dashBoardDetailDataModel.lstgetdetail[index].strManualStatus}",
                                                    style: TextStyle(
                                                        color: Colors.amber,
                                                        fontSize: MediaQuery.of(
                                                                    context)
                                                ...
                                                child: Container(
                                                    width:
                                                        MediaQuery.of(context)
                                                            ...
                                                            .26,
                                                    child: Text(
                                                      "${model.dashBoardDetailDataModel.lstgetdetail[index].strBrokername}",
                                                      style: TextStyle(
                                                          color: Colors.black,
                                                          fontSize: MediaQuery.of(
                                                                      context)
