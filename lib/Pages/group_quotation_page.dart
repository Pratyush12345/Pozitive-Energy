      ...
      body: Padding(
        ...
        child: ListView(
          children: <Widget>[
            ...
            SizedBox(
              height: MediaQuery.of(context).size.height * .065,
              child: innertextfield(groupnameController, false, _autovalidation,
                  TextInputType.text, AppString.groupName, (value) {
                if (value.isEmpty) {
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    InkWell(
                      child: Icon(
                        mop ? Icons.check_box : Icons.check_box_outline_blank,
                        color: Color.fromRGBO(155, 119, 217, 1),
              ...
              child: Container(
                ...
                child: Row(
                  children: <Widget>[
                    ...
                    InkWell(
                      child: Icon(
                        daDc ? Icons.check_box : Icons.check_box_outline_blank,
                        color: Color.fromRGBO(155, 119, 217, 1),
                        size: MediaQuery.of(context).size.height * .023,
                      ),
                      onTap: () {
