...
Widget appbar(String title,BuildContext context, key,bool enableDrawer,bool notficicationIcon){
  return enableDrawer?AppBar(
    leading: InkWell(child: Image.asset("assets/menu.png",scale: 6,),
      onTap: (){
      key.currentState.openDrawer();

    },),
    title: Text(title,style: TextStyle(color: Colors.white,fontSize: MediaQuery.of(context).size.width*0.048)),
    centerTitle: true,
    actions: <Widget>[
    ...
    centerTitle: true,
    actions: <Widget>[
      notficicationIcon?IconButton(icon: Stack(
        children: <Widget>[
          Image.asset("assets/notification.png",scale: 7,),
          Positioned(right: 0,top:-4,child: Container(
            child: Padding(
